                                    ...
                                    <td className="p-4">
                                        <div className="flex items-center justify-center gap-2 sm:gap-4">
                                            ...
                                            <button
                                                ...
                                                className={`flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl border transition-all font-semibold text-sm ${student.status === 'present'
                                            ...
                                            <button
                                                ...
                                                className={`flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl border transition-all font-semibold text-sm ${student.status === 'late'
                                            ...
                                            <button
                                                ...
                                                className={`flex items-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl border transition-all font-semibold text-sm ${student.status === 'absent'
