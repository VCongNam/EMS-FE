...
const CreateAssistantModal = ({ isOpen, onClose, onCreate }) => {
                ...
                >
                    ...
                    <div className="flex items-center justify-between !p-6 border-b border-border rounded-t-3xl shrink-0">
                        <div className="flex items-center !text-primary !gap-4">
                            ...
                            <div>
                                <h2 className="text-xl !text-primary sm:text-2xl font-bold font-['Outfit']">Thêm trợ giảng mới</h2>
                                <p className="text-xs sm:text-sm text-text-muted mt-1">Khởi tạo hồ sơ trợ giảng trên hệ thống</p>
                            </div>
                        </div>
                        <button 
                            type="button"
                    ...
                    {/* Form Body automatically scrolls inside this container */}
                    <form onSubmit={handleSubmit} className="!p-6 md:!p-8 !space-y-8 flex-1 flex flex-col relative">
                        ...
                        <div className="!space-y-6 shrink-0 !mb-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 !gap-x-6 !gap-y-5">
                                ...
                                <div className="!space-y-1 group">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            placeholder="Ghi liền không dấu"
                                            className={inputClasses}
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="!space-y-1 group md:col-span-2 lg:col-span-1">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                            placeholder="SĐT liên hệ với trợ giảng"
                                            className={inputClasses}
                                        />
                                    </div>
                                </div>
