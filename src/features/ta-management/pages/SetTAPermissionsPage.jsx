            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-surface p-6 rounded-[2rem] border border-border shadow-sm">
                <div>
                    <h1 className="text-2xl font-bold text-text-main flex items-center gap-3">
                        <Icon icon="material-symbols:manage-accounts-rounded" className="text-primary text-3xl" />
                        Phân quyền Trợ giảng
                    </h1>
                    <p className="text-text-muted mt-1">Cấu hình các quyền hạn và tính năng trên hệ thống cho TA.</p>
                </div>
            </div>
